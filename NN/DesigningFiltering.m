...
Sub=12;  % What subject you want to access 
F=1 ;      % What time we want to access 
...
%------------------------------------------------------
R=2;  % What study you want to run 
Sub=11;  % What subject you want to access 
F=1 ;      % What time we want to access 
  ...
  [hrv, R_t, R_amp, R_index, S_t, S_amp]  = rpeakdetectNapoli(y3,Fs,.2,0);
  [hrv2, R_t2, R_amp2, R_index2, S_t2, S_amp2]  = rpeakdetect(EKG,Fs);   
