...
addpath(...
    '~/Box Sync/Nasa Flight Data/DataAnalysis_Matt/NASA-PEC-MATLAB/NN/PerformanceData');
...
MATB_SL_Comm = import_matb_subscore_2016_03_17(matb_ts_pec, 2, 'Comm');
MATB_15k_Comm = import_matb_subscore_2016_03_17(matb_ts_pec, 3, 'Comm');

% MATB_RA_ResMan = import_matb_subscore_2016_03_17(matb_ts_pec, 1, 'ResMan');
MATB_SL_ResMan = import_matb_subscore_2016_03_17(matb_ts_pec, 2, 'ResMan');
MATB_15k_ResMan = import_matb_subscore_2016_03_17(matb_ts_pec, 3, 'ResMan');

% MATB_RA_Track = import_matb_subscore_2016_03_17(matb_ts_pec, 1, 'Track');
MATB_SL_Track = import_matb_subscore_2016_03_17(matb_ts_pec, 2, 'Track');
MATB_15k_Track = import_matb_subscore_2016_03_17(matb_ts_pec, 3, 'Track');
