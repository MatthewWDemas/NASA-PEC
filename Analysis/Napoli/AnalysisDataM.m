...
subplot(312)
 for i=1:5
        % Hypoxic Condition
        Loc1=((DataM(:,RunT)==3) + (DataM(:,TimeP)==i)+ (DataM(:,13)==2) )==3; 
        %Loc1=(Loc1-(DataM(:,VarC)==Inf))==1;
        % NonHypoxic Condition
        Loc2=((DataM(:,RunT)==2) + (DataM(:,TimeP)==i) + (DataM(:,13)==2))==3; 
        %Loc2=(Loc2-(DataM(:,VarC)==Inf))==1;
        %plot(i,mean(DataM(Loc1,2)),'-*r')
        errorbar(i,mean(DataM(Loc1,VarC)),1.96*(std(DataM(Loc1,VarC)/sqrt(sum(Loc1)))),'rx')
        hold on 
...
subplot(313)
 for i=1:5
        % Hypoxic Condition
        Loc1=((DataM(:,RunT)==3) + (DataM(:,TimeP)==i)+ (DataM(:,13)==3) )==3; 
        %Loc1=(Loc1-(DataM(:,VarC)==Inf))==1;
        % NonHypoxic Condition
        Loc2=((DataM(:,RunT)==2) + (DataM(:,TimeP)==i) + (DataM(:,13)==3))==3; 
        %Loc2=(Loc2-(DataM(:,VarC)==Inf))==1;
        %plot(i,mean(DataM(Loc1,2)),'-*r')
        errorbar(i,mean(DataM(Loc1,VarC)),1.96*(std(DataM(Loc1,VarC)/sqrt(sum(Loc1)))),'rx')
        hold on 
